...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/COUNTER_160x2/COUNTER_160x2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNTER_160x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNTER_160x2.tcl
