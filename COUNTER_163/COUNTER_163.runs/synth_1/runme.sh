...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/COUNTER_163/COUNTER_163.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNTER_163.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNTER_163.tcl
