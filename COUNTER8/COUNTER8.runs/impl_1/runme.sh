...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/COUNTER8/COUNTER8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNTER8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COUNTER8.tcl -notrace
