...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/COUNTER8/COUNTER8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log COUNTER8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source COUNTER8.tcl
