...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/Parallel_to_Serial/Parallel_to_Serial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PTS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PTS.tcl -notrace
