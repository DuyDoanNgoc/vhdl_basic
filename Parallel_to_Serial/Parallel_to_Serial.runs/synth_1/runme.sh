...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/Parallel_to_Serial/Parallel_to_Serial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PTS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PTS.tcl
